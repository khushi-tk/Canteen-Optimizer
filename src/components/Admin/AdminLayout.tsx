...
interface AdminLayoutProps {
  children: ReactNode;
  activeTab: 'orders' | 'crowd' | 'menu' | 'analytics' | 'inventory';
  onTabChange: (tab: 'orders' | 'crowd' | 'menu' | 'analytics' | 'inventory') => void;
}

interface TabDef {
  id: 'orders' | 'crowd' | 'menu' | 'analytics' | 'inventory';
  label: string;
  icon: (active: boolean) => ReactNode;
}


function inventoryIcon(active: boolean): ReactNode {
  return (
