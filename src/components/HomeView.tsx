    ...
    <div className="pb-48">
      ...
      <div className="flex items-start justify-between px-5 pt-5 pb-3">
        ...
        <button
          type="button"
          onClick={logout}
          className="rounded-lg bg-red-500 px-3 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700 mr-10"
        >
          Logout
        </button>
      </div>
